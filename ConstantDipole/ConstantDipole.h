...
#ifndef __CONSTANTDIPOLE_H__
#define __CONSTANTDIPOLE_H__

#ifdef NVCC
#error This header cannot be compiled by nvcc
#endif

// Declares the ConstantDipole class.
class ConstantDipole : public ForceCompute {

    public:
        // Constructor
        ConstantDipole(std::shared_ptr<SystemDefinition> sysdef,
...
// Exports the ConstantDipole class to python
